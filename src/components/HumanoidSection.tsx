      ...
      <section className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-white" id="why-humanoid">
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          <div className="mb-2 md:mb-3">
            ...
            <h2 className="section-title sm:text-4xl md:text-5xl font-display font-bold mb-1 md:mb-2 text-center text-5xl">Why Logistics Teams Choose ClairTrack</h2>
          </div>
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
            ...
            opacity: isFirstCardVisible ? 0.9 : 0
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl font-display text-white leading-tight mb-4 mx-0 font-bold text-left md:text-4xl">We're giving AI a way to Faster Logistics Operations & Lower Business Costs</h3>
                </div>
              </div>
            </div>
            ...
            pointerEvents: isSecondCardVisible ? 'auto' : 'none'
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">We're bringing adaptive intelligence where 360° fleet visibility meets seamless scaling—empowering you to manage thousands of orders daily without delay </h3>
                </div>
              </div>
            </div>
