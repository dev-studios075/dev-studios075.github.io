        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            animationDelay: "0.3s"
              ...
              Transform the Way<br className="hidden sm:inline" />Your Fleets Move
            </h1>
            <p style={{
            animationDelay: "0.5s"
          }} className="section-subtitle mt-3 sm:mt-6 mb-4 sm:mb-8 leading-relaxed opacity-0 animate-fade-in text-gray-950 font-normal text-base sm:text-lg text-left">
              AI-Powered Dispatch Planner & Fleet Management System designed for modern shippers and transporters.
            </p>
            <ul className="mb-4 sm:mb-8 list-disc list-inside pl-1 text-left text-gray-800 text-base sm:text-lg space-y-1 opacity-0 animate-fade-in" style={{
              animationDelay: "0.6s"
            }}>
              <li>Maximize Fleet Utilization</li>
              <li>Deliver Goods Faster</li>
          ...
          <div className="w-full lg:w-1/2 relative mt-6 lg:mt-0">
            ...
            animationDelay: "0.9s"
              ...
              <div className="relative transition-all duration-500 ease-out overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl">
                <img ref={imageRef} src="/lovable-uploads/efa09310-e40a-41d2-bc26-ac1d143b973a.png" alt="Truck illustration" className="w-full h-auto object-cover transition-transform duration-500 ease-out" style={{
